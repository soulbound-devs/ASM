...
public class ModCreativeModeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SOULBOUND_TAB = CREATIVE_MODE_TAB_REGISTER.register("soulbound", () -> CreativeModeTab.builder().icon(() -> ModItems.SOUL.get().getDefaultInstance()).title(Component.literal("Soulbound")).build());
