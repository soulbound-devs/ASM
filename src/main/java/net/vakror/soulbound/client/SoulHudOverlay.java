...
public class SoulHudOverlay {
    ...
    public static final IGuiOverlay HUD_SOUL = ((gui, graphics, partialTick, width, height) -> {
        if (gui.shouldDrawSurvivalElements()) {
            ...
            graphics.drawString(Minecraft.getInstance().font, (int) soul + "/" + (int) maxSoul, x - 145 - soulWidth, y - 80, FastColor.ARGB32.color(255, 255, 255, 255));
            graphics.drawString(Minecraft.getInstance().font, (int) darkSoul + "/" + (int) maxDarkSoul, x - 98 - darkSoulWidth, y - 80, FastColor.ARGB32.color(255, 255, 255, 255));
